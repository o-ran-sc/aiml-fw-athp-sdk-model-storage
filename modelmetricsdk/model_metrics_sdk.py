...
class ModelMetricsSdk:
    ...
    def archived_upload_metrics(self, metrics, model_name, model_version, artifact_version):
        """
    ...
    def archived_get_metrics(self, model_name, model_version, artifact_version):
        """
